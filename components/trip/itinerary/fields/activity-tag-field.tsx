...
/**
 * ActivityTagField — extracted from edit-item-form.tsx (pre-split).
 *
 * W1b (activity-tag) will replace this freeform input with a chip picker.
...
export function ActivityTagField({ value, onChange, disabled }: ActivityTagFieldProps) {
  return (
    <div>
