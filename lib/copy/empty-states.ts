...
export const M3_UI_STRINGS = {
  ...
  itineraryForm_location_label: "Location (optional)",
  itineraryForm_location_placeholder: "Venue name — e.g. 'the Airbnb', 'Rafting Co. HQ'",
  itineraryForm_notes_label: "Notes (optional)",
  itineraryForm_notes_placeholder: "Anything to know — what to bring, where to meet…",
